...
def analyze_neutrons(fin_dir, fout_np_dir):
    ...
    '''
    Function to analyze neutron simulations with particle tracks ON.
    Returns a npz file with a sumamry of the desired information.

    Parameters:
    - fin_dir: directory + file name of the neutron simulation to be analized.
    - fout_np_dir: directory and file name where to save the analysis results.
    '''
